"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.pullLeversExt = void 0;
...
var _skillHelpers = await jitiImport("../skill-helpers"); // Extension nodes for the "pull_levers" sector — the beginner on-ramp beneath the
...
//
// RINGS: -3 is this sector's new floor (buildSkills normalizes it to 0), matching the
// dips_planche_hs floor — the two sectors are coupled by the cross-sector edge
// maltese.lean ← iron_cross.iron_cross, which only survives normalization while the two
// sectors' shifts stay within 1 of each other. On-ramp levels are spaced 0.3 apart;
// fractional positive rings insert between the authored integer rings. Every prereq's
// ring is strictly smaller than its dependent's, including the spliced `rewire` edges.
const S = "pull_levers";const pullLeversExt = exports.pullLeversExt = { nodes: [// ================================================================== ring -3
  // Day one. No pull-up strength assumed; a bar (or just a band) is all that is needed.
  (0, _skillHelpers.node)("pull.dead_hang", "Dead Hang", S, -3, (0, _skillHelpers.hold)(30), [], { description: "30 s relaxed two-arm hang, shoulders loose, full grip. Build toward the routine's pull-08 target of 60 s. Grip, not lats, is the limiter here (doc 04 §3.4)." }), (0, _skillHelpers.node)("pull.band_pull", "Band Pull", S, -3, (0, _skillHelpers.reps)(15, 2), [], { evidence: "D", description: "2×15 seated or standing band row: elbows to the ribs, shoulder blades finishing together. The zero-equipment entry to the whole sector (seed slot pull-03, band 2)." }), // ================================================================ ring -2.7
  (0, _skillHelpers.node)("pull_base.scap_pull", "Scapular Pull-Up", S, -2.7, (0, _skillHelpers.reps)(8, 3), ["pull.dead_hang"], { description: "3×8 straight-arm scapular pulls from a dead hang — elbows locked, chest rises 5–8 cm on shoulder depression alone. Doc 01 §3.2/§3.8 name this the prehab gate for the whole sector." }), (0, _skillHelpers.node)("pull.row_incline", "Incline Row", S, -2.7, (0, _skillHelpers.reps)(12, 3), ["pull.band_pull"], { evidence: "D", description: "Bar or rings at chest height, torso steep (~60° from horizontal), feet under you — the elevated/easy row, ≈0.55×BW. Walk the feet out to lower the angle." }), // ================================================================ ring -2.4
  (0, _skillHelpers.node)("pull_base.active_hang", "Active Hang 45 s", S, -2.4, (0, _skillHelpers.hold)(45), ["pull_base.scap_pull"], { description:
  ...
  (0, _skillHelpers.node)("pull.scap_row", "Scapula Row", S, -2.4, (0, _skillHelpers.reps)(10, 3), ["pull.row_incline"], {
    evidence: "D",
    description:
  ...
  (0, _skillHelpers.node)("pull.row_bodyweight", "Bodyweight Row", S, -2.4, (0, _skillHelpers.reps)(10, 3), ["pull.row_incline"], {
    description:
    "3×10 horizontal row: body in one line, heels on the floor, chest touches the bar. ≈0.72×BW (doc 02 inverted-row load fractions)."
  }),
  (0, _skillHelpers.node)("pull.pullup_assisted", "Band-Assisted Pull-Up", S, -2.4, (0, _skillHelpers.reps)(8, 3), [
  "pull_base.scap_pull",
  "pull.row_incline"],
  {
    evidence: "D",
  ...
  // ================================================================ ring -2.1
  (0, _skillHelpers.node)("pull_base.inverted_hang", "Inverted Hang", S, -2.1, (0, _skillHelpers.hold)(20, 3), ["pull_base.active_hang"], {
    sa: true,
    evidence: "D",
    description:
  ...
  (0, _skillHelpers.node)("pull.row_decline", "Decline Row", S, -2.1, (0, _skillHelpers.reps)(10, 3), ["pull.row_bodyweight"], {
    description: "3×10 with the feet elevated to bar height — ≈0.85×BW, the hardest unloaded row."
  }),
  (0, _skillHelpers.node)("pull.one_arm_row_rotation", "One-Arm Row + Rotate", S, -2.1, (0, _skillHelpers.reps)(8, 2, true), [
  "pull.row_bodyweight"],
  {
    evidence: "D",
    description:
  ...
  (0, _skillHelpers.node)("pull.pullup_negative", "Pull-Up Negative 5 s", S, -2.1, (0, _skillHelpers.reps)(5, 3), ["pull.pullup_assisted"], {
    description:
  ...
  (0, _skillHelpers.node)("pull_base.top_hold", "Chin-Over-Bar Hold", S, -2.1, (0, _skillHelpers.hold)(20, 3), ["pull.pullup_assisted"], {
    evidence: "D",
    description:
  ...
  // ================================================================ ring -1.8
  (0, _skillHelpers.node)("back_lever.skin_cat_assisted", "Assisted Skin-the-Cat", S, -1.8, (0, _skillHelpers.reps)(5, 3), [
  ...
  (0, _skillHelpers.node)("pull.row_decline_weighted", "Weighted Decline Row", S, -1.8, (0, _skillHelpers.wreps)(8, 0.2, 3), ["pull.row_decline"], {
    evidence: "D",
    description: "3×8 feet-elevated row with +20% BW in a vest or on the hips — the top of the row branch."
  }),
  (0, _skillHelpers.node)("pull_base.jumping_pullup", "Jumping Pull-Up", S, -1.8, (0, _skillHelpers.reps)(8, 3), ["pull.pullup_negative"], {
    evidence: "D",
    description:
  ...
  (0, _skillHelpers.node)("pull_base.half_rom_pullup", "Half-ROM Pull-Up", S, -1.8, (0, _skillHelpers.reps)(5, 3), ["pull_base.top_hold"], {
    evidence: "D",
    description:
  ...
  // ================================================================ ring -1.5
  (0, _skillHelpers.node)("back_lever.skin_cat", "Skin-the-Cat", S, -1.5, (0, _skillHelpers.reps)(5, 3), ["back_lever.skin_cat_assisted"], {
    sa: true,
    description:
  ...
  (0, _skillHelpers.node)("pull_base.chinup1", "First Chin-Up", S, -1.5, (0, _skillHelpers.reps)(1), [
  ...
  // ================================================================ ring -1.2
  (0, _skillHelpers.node)("pull_base.pullup1", "First Pull-Up", S, -1.2, (0, _skillHelpers.reps)(1), ["pull_base.chinup1"], {
    estMonths: [2, 6],
    description: "One strict pronated dead-hang pull-up, chin fully over the bar, no swing."
  }),

  // ================================================================ ring -0.9
  (0, _skillHelpers.node)("pull_base.pullup3", "Strict Pull-Ups ×3", S, -0.9, (0, _skillHelpers.reps)(3), ["pull_base.pullup1"], {
    evidence: "D",
    description: "3 strict reps in one set — the first rep milestone that turns into real training volume."
  }),

  // ================================================================ ring -0.6
  (0, _skillHelpers.node)("pull_base.pullup5", "Strict Pull-Ups ×5", S, -0.6, (0, _skillHelpers.reps)(5), ["pull_base.pullup3"], {
    description: "5 strict reps — doc 01 §3.5's stated entry threshold for muscle-up work."
  }),

  // ================================================================ ring -0.3
  (0, _skillHelpers.node)("pull_base.pullup8", "Strict Pull-Ups ×8", S, -0.3, (0, _skillHelpers.reps)(8), ["pull_base.pullup5"], {
    description:
    "8 strict reps — doc 01 §3.13's rope-climb base and the last rung below the authored ×10 hub."
  }),

  // ================================================================ ring 0.25
  (0, _skillHelpers.node)("front_lever.tuck_hang", "Tuck FL Hang", S, 0.25, (0, _skillHelpers.hold)(20, 3), [
  "pull_base.pullup5",
  "pull_base.inverted_hang"],
  {
    sa: true,
  ...
  // ================================================================= ring 0.5
  (0, _skillHelpers.node)("pull_base.wpu_10pct", "Weighted Pull-Up +10%", S, 0.5, (0, _skillHelpers.wreps)(5, 0.1, 3), [
  "one_arm_pullup.pullup10"],
  {
    description: "3×5 at +10% BW — the first loaded rung of doc 01 §3.8's ordered chain (+10 / 20 / 30%)."
  }),
  (0, _skillHelpers.node)("pull_base.c2b_pullup", "Chest-to-Bar Pull-Up", S, 0.5, (0, _skillHelpers.reps)(5, 3), ["one_arm_pullup.pullup10"], {
    description:
  ...
  (0, _skillHelpers.node)("pull.towel_pullup_assisted", "Assisted Towel Pull-Up", S, 0.5, (0, _skillHelpers.reps)(8, 2), ["pull_base.pullup5"], {
    evidence: "D",
    description:
  ...
  // ================================================================ ring 0.75
  (0, _skillHelpers.node)("front_lever.tuck_10s", "Tuck Front Lever 10 s", S, 0.75, (0, _skillHelpers.hold)(10, 3), ["front_lever.tuck_hang"], {
    sa: true,
    evidence: "D",
    description:
  ...
  // ================================================================= ring 1.5
  (0, _skillHelpers.node)("pull_base.wpu_35pct", "Weighted Pull-Up +35%", S, 1.5, (0, _skillHelpers.wreps)(3, 0.35), [
  "one_arm_pullup.wpu_25pct"],
  {
    description:
    "3 reps @ +35% BW — the top of doc 01 §3.8's +25–45% 'sensible entry' band, halfway to the +50% checkpoint."
  }),
  (0, _skillHelpers.node)("pull_base.lsit_pullup", "L-Sit Pull-Up", S, 1.5, (0, _skillHelpers.reps)(5, 3), ["pull_base.c2b_pullup"], {
    evidence: "D",
    description:
  ...
  // ================================================================= ring 3.5
  (0, _skillHelpers.node)("pull_base.typewriter_pullup", "Typewriter Pull-Up", S, 3.5, (0, _skillHelpers.reps)(3, 3, true), [
  ...
  // ================================================================= ring 4.5
  (0, _skillHelpers.node)("pull_base.wpu_70pct", "Weighted Pull-Up +70%", S, 4.5, (0, _skillHelpers.wreps)(1, 0.7), ["one_arm_pullup.wpu_50pct"], {
    description:
  ...
  // ================================================================= ring 5.5
  (0, _skillHelpers.node)("pull_base.oap_negative_10s", "OAP Negative 10 s", S, 5.5, (0, _skillHelpers.reps)(3, 3, true), [
