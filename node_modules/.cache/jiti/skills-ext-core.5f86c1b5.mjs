"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.coreExt = void 0;
...
var _skillHelpers = await jitiImport("../skill-helpers"); // Extension nodes for the "core" sector — the beginner on-ramp plus the missing
...
const SECTOR = "core";const coreExt = exports.coreExt = { nodes: [// ---------------------------------------------------------------- ring -1.8
  ...
  (0, _skillHelpers.node)("core.dead_bug", "Dead Bug", SECTOR, -1.8, (0, _skillHelpers.reps)(10, 3, true), [], { description: "3×10 slow alternating reps per side, opposite arm + leg, low back pressed flat to the floor the whole time. The day-one entry to the hollow-body line." }), (0, _skillHelpers.node)("core.knee_plank", "Knee Plank", SECTOR, -1.8, (0, _skillHelpers.hold)(30, 3), [], { description: "3×30 s from the knees: straight line knee→hip→shoulder, ribs down, glutes on." }), (0, _skillHelpers.node)("core.elbow_to_knee", "Knee-to-Elbow Crunch", SECTOR, -1.8, (0, _skillHelpers.reps)(15, 3), [], { description: "3×15 alternating. Logged directly by the routine (legs-09 / full-07, easiest band)." }), (0, _skillHelpers.node)("core.floor_support", "Floor Support Hold", SECTOR, -1.8, (0, _skillHelpers.hold)(15, 3), [], { description: "Sit with legs straight, hands flat beside the hips, press the hips off the floor and hold 3×15 s. Heels may stay down. Teaches the shoulder depression the parallette support hold gates on (doc 01 §3.10 step 1)." }), // --------------------------------------------------------------- ring -1.35
  (0, _skillHelpers.node)("core.hollow_tuck", "Tuck Hollow Hold", SECTOR, -1.35, (0, _skillHelpers.hold)(20, 3), ["core.dead_bug"], { description: "3×20 s with hips and knees at 90°, arms alongside the shins, lumbar spine glued down."
    }),
  (0, _skillHelpers.node)("core.plank_30s", "Front Plank 30 s", SECTOR, -1.35, (0, _skillHelpers.hold)(30), ["core.knee_plank"], {
    evidence: "B",
    description:
    "One 30 s forearm plank, strict hips — the Poor/Fair boundary of the plank norms (doc 04 §3.3). Stop the clock on sag or pike."
  }),
  (0, _skillHelpers.node)("core.lying_leg_raise", "Lying Leg Raise", SECTOR, -1.35, (0, _skillHelpers.reps)(12, 3), ["core.dead_bug"], {
    description:
    "3×12 straight legs to vertical, lowered to a hover without the lumbar spine leaving the floor. Logged by legs-10."
  }),
  (0, _skillHelpers.node)("core.side_plank_knee", "Knee Side Plank", SECTOR, -1.35, (0, _skillHelpers.hold)(20, 2), ["core.knee_plank"], {
    description: "2×20 s per side, bottom knee down, hips fully stacked."
  }),

  // ---------------------------------------------------------------- ring -0.9
  (0, _skillHelpers.node)("core.hollow_one_leg", "One-Leg Hollow Hold", SECTOR, -0.9, (0, _skillHelpers.hold)(20, 3), ["core.hollow_tuck"], {
    description: "3×20 s with one leg extended and one tucked; swap legs halfway through each set."
  }),
  (0, _skillHelpers.node)("core.plank_60s", "Front Plank 60 s", SECTOR, -0.9, (0, _skillHelpers.hold)(60), ["core.plank_30s"], {
    evidence: "B",
    description: "60 s strict — the Average band of the plank norms (doc 04 §3.3). Add time, never sag."
  }),
  (0, _skillHelpers.node)("core.side_plank_45s", "Side Plank 45 s", SECTOR, -0.9, (0, _skillHelpers.hold)(45, 2), ["core.side_plank_knee"], {
    description:
  ...
  (0, _skillHelpers.node)("core.x_up", "X-Up", SECTOR, -0.9, (0, _skillHelpers.reps)(15, 3), ["core.elbow_to_knee"], {
    description: "3×15. Hardest band of the routine's legs-09 crunch slot, so it is logged automatically."
  }),
  (0, _skillHelpers.node)("core.seated_leg_raise", "Seated Leg Raise", SECTOR, -0.9, (0, _skillHelpers.reps)(10, 3), ["core.floor_support"], {
    description:
  ...
  (0, _skillHelpers.node)("core.wall_rollout", "Wall Roll-Out", SECTOR, -0.9, (0, _skillHelpers.reps)(12, 3), ["core.plank_30s"], {
    sa: true,
    description:
  ...
  // --------------------------------------------------------------- ring -0.45
  (0, _skillHelpers.node)("core.hollow_15s", "Hollow Hold 15 s", SECTOR, -0.45, (0, _skillHelpers.hold)(15), ["core.hollow_one_leg"], {
    description:
  ...
  (0, _skillHelpers.node)("core.long_lever_plank", "Long-Lever Plank", SECTOR, -0.45, (0, _skillHelpers.hold)(45, 3), ["core.plank_60s"], {
    description: "3×45 s with the forearms shifted well ahead of the shoulders — the plank ladder's top rung."
  }),
  (0, _skillHelpers.node)("core.hanging_frog_kick", "Hanging Knee Raise", SECTOR, -0.45, (0, _skillHelpers.reps)(10, 3), [
  ...
  (0, _skillHelpers.node)("core.rollout_knees_partial", "Knee Roll-Out (part)", SECTOR, -0.45, (0, _skillHelpers.reps)(10, 3), ["core.wall_rollout"], {
    sa: true,
    description:
  ...
  // ----------------------------------------------------------------- ring 0.4
  (0, _skillHelpers.node)("core.tuck_hold", "Tuck Support Hold", SECTOR, 0.4, (0, _skillHelpers.hold)(20, 3), ["l_sit_manna.support"], {
    description:
  ...
  // ----------------------------------------------------------------- ring 0.5
  (0, _skillHelpers.node)("core.df_negative", "Dragon Flag Negative", SECTOR, 0.5, (0, _skillHelpers.reps)(5, 3), ["dragon_flag.hollow"], {
    description:
  ...
  (0, _skillHelpers.node)("core.ab_rollout_knees", "Knee Roll-Out", SECTOR, 0.5, (0, _skillHelpers.reps)(8, 3), [
  ...
  (0, _skillHelpers.node)("core.hanging_leg_raise", "Hanging Leg Raise", SECTOR, 0.5, (0, _skillHelpers.reps)(10, 3), ["core.hanging_frog_kick"], {
    description: "3×10 straight legs to horizontal, lowered under control. Hardest band of legs-05."
  }),

  // ----------------------------------------------------------------- ring 1.5
  (0, _skillHelpers.node)("core.df_one_leg", "One-Leg Dragon Flag", SECTOR, 1.5, (0, _skillHelpers.hold)(8, 3), ["dragon_flag.tuck"], {
    description: "3×8 s per side, one leg extended and one tucked — the standard rung between tuck and straddle."
  }),
  (0, _skillHelpers.node)("core.toes_to_bar", "Toes-to-Bar", SECTOR, 1.5, (0, _skillHelpers.reps)(8, 3), ["core.hanging_leg_raise"], {
    description: "3×8 strict, toes touching the bar, no kip and no swing between reps."
  }),
  (0, _skillHelpers.node)("core.rollout_standing_part", "Standing Roll-Out ½", SECTOR, 1.5, (0, _skillHelpers.reps)(8, 3), ["core.ab_rollout_knees"], {
    sa: true,
    description:
  ...
  // ----------------------------------------------------------------- ring 2.2
  (0, _skillHelpers.node)("core.lsit_5s", "L-Sit 5 s", SECTOR, 2.2, (0, _skillHelpers.hold)(5, 3), ["l_sit_manna.tuck_l"], {
    description:
  ...
  // ----------------------------------------------------------------- ring 2.5
  (0, _skillHelpers.node)("core.lsit_15s", "L-Sit 15 s", SECTOR, 2.5, (0, _skillHelpers.hold)(15, 3), ["core.lsit_5s"], {
    description: "3×15 s, knees locked and heels above hip height. Accumulate 60 s/day as practice (doc 01 §3.10)."
  }),
  (0, _skillHelpers.node)("core.df_full_negative", "Full DF Negative", SECTOR, 2.5, (0, _skillHelpers.reps)(5, 3), ["dragon_flag.straddle"], {
    description: "3×5 straight-body descents at ~5 s each — the bridge from the straddle to the full 3×10 s hold."
  }),
  (0, _skillHelpers.node)("core.ab_rollout", "Standing Roll-Out", SECTOR, 2.5, (0, _skillHelpers.reps)(5, 3), ["core.rollout_standing_part"], {
    sa: true,
    estMonths: [6, 18],
  ...
  // ----------------------------------------------------------------- ring 4.5
  (0, _skillHelpers.node)("core.pike_compression", "Pike Compression Lift", SECTOR, 4.5, (0, _skillHelpers.reps)(10, 3), ["l_sit_manna.straddle_l"], {
    description:
