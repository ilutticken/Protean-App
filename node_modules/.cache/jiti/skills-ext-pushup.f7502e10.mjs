"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.pushupExt = void 0;
...
var _skillHelpers = await jitiImport("../skill-helpers"); // Extension nodes for the "pushup" sector (horizontal press).
//
...
const S = "pushup";const pushupExt = exports.pushupExt = { nodes: [// ------------------------------------------------------------------ on-ramp
  // Day-one entries (no prereqs): the two things an untrained adult can always do.
  (0, _skillHelpers.node)("pushup_base.wall_pushup", "Wall Push-Up", S, -0.9, (0, _skillHelpers.reps)(20, 3), [], { estMonths: [0, 1], description: "Hands on a wall at chest height, feet one step back, body one line from ear to heel. Lower until the nose touches. 3×20 before moving to a lower surface." }), (0, _skillHelpers.node)("pushup_base.high_plank", "High Plank", S, -0.9, (0, _skillHelpers.hold)(30, 3), [], { description: "3×30 s rigid straight-arm plank — ribs down, glutes on. Doc 01 §3.7 names this as the position gate for the whole push-up line." }), // Barbell on-ramp for the bench line. Kept at the sector MINIMUM ring so it normalizes
  ...
  (0, _skillHelpers.node)("barbell_bench.0_5xbw", "Bench Press 0.5×BW", S, -0.9, (0, _skillHelpers.e1rmRatio)("bench", 0.5), [], { evidence: "D", description: "On-ramp below the existing 0.75×BW node: half-bodyweight bench with a coached setup (feet planted, bar to sternum, no bounce, full lockout)." }), (0, _skillHelpers.node)("pushup_base.counter_pushup", "Counter Push-Up", S, -0.8, (0, _skillHelpers.reps)(15, 3), ["pushup_base.wall_pushup"], { description: "Hands on a kitchen counter / waist-high rail (~60 cm): ≈41% BW vs 64% flat (Ebben 2011, doc 02 §5.1). 3×15 full ROM, chest to hands." }),
  (0, _skillHelpers.node)("push.pushup_knees", "Knee Push-Up", S, -0.7, (0, _skillHelpers.reps)(15, 3), [
  ...
  (0, _skillHelpers.node)("push.pushup_incline", "Incline Push-Up", S, -0.6, (0, _skillHelpers.reps)(15, 3), ["push.pushup_knees"], {
    description:
  ...
  (0, _skillHelpers.node)("pushup_base.band_pushup", "Banded Push-Up", S, -0.5, (0, _skillHelpers.reps)(12, 3), ["push.pushup_incline"], {
    evidence: "D",
    description:
  ...
  (0, _skillHelpers.node)("pushup_base.partial_pushup", "Partial-ROM Push-Up", S, -0.5, (0, _skillHelpers.reps)(10, 3), ["push.pushup_incline"], {
    evidence: "D",
    description:
    "Floor push-up stopping on a 10–15 cm block or folded cushion under the chest. 3×10, then remove one layer."
  }),
  (0, _skillHelpers.node)("pushup_base.pushup_negative", "Negative Push-Up", S, -0.4, (0, _skillHelpers.reps)(5, 3), ["pushup_base.partial_pushup"], {
    description:
  ...
  (0, _skillHelpers.node)("qi.incline_pushup", "Quasi-Iso Incline", S, -0.4, (0, _skillHelpers.hold)(60), ["push.pushup_incline"], {
    evidence: "D",
    description: "60 s continuous quasi-isometric descent/hold on a bench — slot push-09, band 1."
  }),

  (0, _skillHelpers.node)("pushup_base.first_pushup", "First Full Push-Up", S, -0.3, (0, _skillHelpers.reps)(1), ["pushup_base.pushup_negative"], {
    estMonths: [1, 4],
    description:
    "ONE clean rep from the floor: chest touches, elbows ~45°, hips locked, no worm. The single milestone this sector was missing."
  }),
  (0, _skillHelpers.node)("push.band_press_staggered", "Staggered Band Press", S, -0.3, (0, _skillHelpers.reps)(15, 3, true), ["push.pushup_incline"], {
    evidence: "D",
    description:
  ...
  (0, _skillHelpers.node)("pushup_base.pushup_10", "Push-Up ×10", S, -0.2, (0, _skillHelpers.reps)(10, 3), ["pushup_base.first_pushup"], {
    description: "3×10 clean full-ROM push-ups — half the hub's requirement, and the honest gate for it."
  }),

  (0, _skillHelpers.node)("qi.pushup", "Quasi-Iso Push-Up", S, -0.1, (0, _skillHelpers.hold)(60), ["pushup_base.pushup_10", "qi.incline_pushup"], {
    evidence: "D",
    description: "60 s quasi-isometric push-up on the floor — slot push-09, band 0."
  }),
  (0, _skillHelpers.node)("push.fingertip_pushup_knees", "Fingertip Knee Push-Up", S, -0.1, (0, _skillHelpers.reps)(10, 3), ["pushup_base.pushup_10"], {
    description:
  ...
  (0, _skillHelpers.node)("pushup_base.wide_pushup", "Wide Push-Up", S, 0.5, (0, _skillHelpers.reps)(15, 3), ["one_arm_pushup.pushup"], {
    description: "Hands ~1.5× shoulder width, elbows out to ~60°. 3×15 — more pec, less triceps."
  }),
  (0, _skillHelpers.node)("pushup_base.close_pushup", "Close-Grip Push-Up", S, 0.5, (0, _skillHelpers.reps)(12, 3), ["one_arm_pushup.pushup"], {
    description: "Hands inside shoulder width, elbows brushing the ribs. 3×12 — the missing rung before the diamond."
  }),
  (0, _skillHelpers.node)("pushup_base.tempo_pushup", "Tempo Push-Up (3-1-1)", S, 0.5, (0, _skillHelpers.reps)(8, 3), ["one_arm_pushup.pushup"], {
    description: "3 s down, 1 s dead-stop on the floor, 1 s up. 3×8 — builds control without adding reps."
  }),
  (0, _skillHelpers.node)("push.fingertip_pushup", "Fingertip Push-Up", S, 0.5, (0, _skillHelpers.reps)(10, 3), [
  ...
  (0, _skillHelpers.node)("pushup_base.knuckle_pushup", "Knuckle Push-Up", S, 0.5, (0, _skillHelpers.reps)(15, 3), ["one_arm_pushup.pushup"], {
    description:
  ...
  (0, _skillHelpers.node)("pushup_decline.feet_30cm", "Decline Push-Up", S, 0.5, (0, _skillHelpers.reps)(12, 3), ["one_arm_pushup.pushup"], {
    description: "Feet on a ~30 cm box: ≈70% BW vs 64% flat (Ebben 2011). 3×12."
  }),

  // ------------------------------------------------- intermediate rungs (ring 1.5)
  (0, _skillHelpers.node)("pushup_decline.feet_61cm", "High Decline Push-Up", S, 1.5, (0, _skillHelpers.reps)(10, 3), ["pushup_decline.feet_30cm"], {
    description: "Feet on a ~60 cm bench: ≈75% BW. 3×10 — shoulders now take a real share of the load."
  }),
  (0, _skillHelpers.node)("pushup_base.deficit_pushup", "Deficit Push-Up", S, 1.5, (0, _skillHelpers.reps)(10, 3), ["pushup_base.close_pushup"], {
    description:
    "Hands on parallettes / two low blocks so the chest sinks well below the hands. 3×10 at a range the floor cannot give you."
  }),
  (0, _skillHelpers.node)("push.explosive_pushup", "Explosive Push-Up", S, 1.5, (0, _skillHelpers.reps)(8, 3), [
  "one_arm_pushup.pushup",
  ...
  (0, _skillHelpers.node)("pushup_uni.uneven_pushup", "Uneven Push-Up", S, 1.5, (0, _skillHelpers.reps)(8, 3, true), ["one_arm_pushup.diamond"], {
    description:
  ...
  (0, _skillHelpers.node)("pushup_base.clap_pushup", "Clap Push-Up", S, 2.5, (0, _skillHelpers.reps)(5, 3), ["push.explosive_pushup"], {
    estMonths: [2, 6],
    description: "3×5 with a full clap at the top. Requires a push-up you can already do explosively for 8."
  }),
  (0, _skillHelpers.node)("pushup_uni.typewriter", "Typewriter Push-Up", S, 2.5, (0, _skillHelpers.reps)(5, 3, true), ["one_arm_pushup.archer"], {
    description:
    "Stay low and slide side-to-side between the archer end positions. 3×5 per side, chest skimming the floor throughout."
  }),
  (0, _skillHelpers.node)("pushup_uni.oap_box", "One-Arm Box Push-Up", S, 2.5, (0, _skillHelpers.reps)(5, 3, true), ["one_arm_pushup.archer"], {
    evidence: "D",
    description:
  ...
  (0, _skillHelpers.node)("pushup_uni.oap_band", "Banded One-Arm Push-Up", S, 3.5, (0, _skillHelpers.reps)(5, 3, true), [
  ...
  (0, _skillHelpers.node)("pushup_uni.oap_partial", "One-Arm Partial ROM", S, 4.5, (0, _skillHelpers.reps)(5, 3, true), ["one_arm_pushup.oap_negative"], {
    evidence: "D",
    description:
