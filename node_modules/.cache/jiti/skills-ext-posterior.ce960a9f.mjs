"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.posteriorExt = void 0;
...
var _skillHelpers = await jitiImport("../skill-helpers"); // Extension nodes for the "posterior" sector (hamstrings / glutes / calves).
...
const posteriorExt = exports.posteriorExt = { nodes: [// ---------------------------------------------------------------- ring -7
  // Day one. No equipment, no hinge competence assumed, nothing to fall out of.
  (0, _skillHelpers.node)("posterior_base.glute_bridge_hold", "Glute Bridge Hold", "posterior", -7, (0, _skillHelpers.hold)(30, 2), [], { description: "2×30 s supine bridge: heels under knees, ribs down, squeeze the glutes — the hips do the lifting, not the low back. The sector's day-one entry point." }), (0, _skillHelpers.node)("posterior_base.calf_raise_seated", "Seated Calf Raise", "posterior", -7, (0, _skillHelpers.reps)(20, 3), [], { description: "3×20 seated (knee bent ~90°) — soleus-biased and the gentlest possible Achilles entry." }), // ---------------------------------------------------------------- ring -6
  (0, _skillHelpers.node)("posterior_base.feet_elev_bridge", "Feet-Elevated Bridge", "posterior", -6, (0, _skillHelpers.reps)(15, 3), ["posterior_base.glute_bridge_hold"], { description: "3×15 with heels on a chair or step — longer lever, more hamstring than the floor bridge." }), (0, _skillHelpers.node)("hinge.good_morning", "Good Morning", "posterior", -6, (0, _skillHelpers.reps)(15, 2), ["posterior_base.glute_bridge_hold"], { description: "2×15 bodyweight hip hinge, hands behind the head, back flat, knees soft — teaches the hinge before any load (seed slot legs-03, easiest step)." }),
  (0, _skillHelpers.node)("squat.calf_raise", "Standing Calf Raise", "posterior", -6, (0, _skillHelpers.reps)(20, 3), [
  "posterior_base.calf_raise_seated"],
  { description: "3×20 double-leg standing, full range, 1 s pause at the top (seed slot legs-08)." }),

  // ---------------------------------------------------------------- ring -5
  (0, _skillHelpers.node)("hinge.glute_bridge_unilateral", "1-Leg Glute Bridge", "posterior", -5, (0, _skillHelpers.reps)(12, 2, true), [
  ...
  (0, _skillHelpers.node)("posterior_base.calf_raise_single", "1-Leg Calf Raise", "posterior", -5, (0, _skillHelpers.reps)(15, 3, true), [
  "squat.calf_raise"],
  { description: "3×15 per side, fingertips on a wall for balance only." }),
  (0, _skillHelpers.node)("hinge.good_morning_weighted", "Weighted Good Morning", "posterior", -5, (0, _skillHelpers.wreps)(12, 0.2, 2), [
  "hinge.good_morning"],
  { description: "2×12 @ +20% BW across the upper back (seed slot legs-03, middle step)." }),

  // ---------------------------------------------------------------- ring -4
  (0, _skillHelpers.node)("posterior_base.hip_thrust_bw", "Bench Hip Thrust", "posterior", -4, (0, _skillHelpers.reps)(15, 3), [
  ...
  (0, _skillHelpers.node)("posterior_base.slider_curl_double", "Slider Leg Curl", "posterior", -4, (0, _skillHelpers.reps)(10, 3), [
  "hinge.glute_bridge_unilateral"],
  {
    evidence: "D",
  ...
  (0, _skillHelpers.node)("hinge.rdl", "Romanian Deadlift", "posterior", -4, (0, _skillHelpers.wreps)(10, 0.5, 3), ["hinge.good_morning_weighted"], {
    description: "3×10 @ 0.5×BW, bar close, knees fixed, stop where the back would round (seed slot legs-03, hardest step)."
  }),

  // ---------------------------------------------------------------- ring -3
  (0, _skillHelpers.node)("posterior_base.slider_curl_single", "1-Leg Slider Curl", "posterior", -3, (0, _skillHelpers.reps)(8, 3, true), [
  ...
  (0, _skillHelpers.node)("posterior_base.ham_walkout", "Hamstring Walkout", "posterior", -3, (0, _skillHelpers.reps)(8, 3), [
  "posterior_base.slider_curl_double"],
  ...
  (0, _skillHelpers.node)("squat.deficit_calf_raise", "Weighted Deficit Raise", "posterior", -3, (0, _skillHelpers.wreps)(12, 0.25, 3), [
  ...
  (0, _skillHelpers.node)("posterior_base.hyper_45", "45° Back Extension", "posterior", -3, (0, _skillHelpers.reps)(15, 3), ["hinge.rdl"], {
  ...
  (0, _skillHelpers.node)("hinge.kb_swing", "Kettlebell Swing", "posterior", -3, (0, _skillHelpers.wreps)(20, 0.2, 2), ["hinge.rdl"], {
    description: "2×20 @ ~20% BW — the hinge made ballistic; the bell floats, the hips snap (seed slot legs-04-alt)."
  }),

  // ---------------------------------------------------------------- ring -2
  (0, _skillHelpers.node)("barbell.hip_thrust", "Barbell Hip Thrust", "posterior", -2, (0, _skillHelpers.wreps)(8, 0.75, 3), [
  ...
  (0, _skillHelpers.node)("posterior_base.calf_single_deficit", "1-Leg Deficit Raise", "posterior", -2, (0, _skillHelpers.wreps)(10, 0.2, 3), [
  ...
  (0, _skillHelpers.node)("hinge.kb_swing_overspeed", "Overspeed KB Swing", "posterior", -2, (0, _skillHelpers.wreps)(20, 0.25, 2), ["hinge.kb_swing"], {
    evidence: "D",
  ...
  // ---------------------------------------------------------------- ring -1
  (0, _skillHelpers.node)("barbell_deadlift.1_0xbw", "Deadlift 1.0×BW", "posterior", -1, (0, _skillHelpers.e1rmRatio)("deadlift", 1.0), ["hinge.rdl"], {
    evidence: "B",
  ...
  (0, _skillHelpers.node)("barbell_deadlift.1_25xbw", "Deadlift 1.25×BW", "posterior", -0.5, (0, _skillHelpers.e1rmRatio)("deadlift", 1.25), [
  ...
  (0, _skillHelpers.node)("nordic_curl.high_assist_nordic", "High-Assist Nordic", "posterior", 0.5, (0, _skillHelpers.reps)(6, 3), [
  ...
  (0, _skillHelpers.node)("posterior_base.slr_rdl_weighted", "Weighted 1-Leg RDL", "posterior", 1, (0, _skillHelpers.wreps)(8, 0.3, 3), [
  "nordic_curl.bridge_slr"],
  { description: "3×8 per side holding ~30% BW. Loaded unilateral hinge — the strength side-branch off the hamstring hub." }),
  (0, _skillHelpers.node)("nordic_curl.low_assist_nordic", "Low-Assist Nordic", "posterior", 1.5, (0, _skillHelpers.reps)(6, 3), [
  ...
  (0, _skillHelpers.node)("posterior_base.ghr", "Glute-Ham Raise", "posterior", 1.5, (0, _skillHelpers.reps)(8, 3), ["nordic_curl.assisted_nordic"], {
  ...
  (0, _skillHelpers.node)("nordic_curl.ecc_3s", "Nordic Negative 3 s", "posterior", 2.5, (0, _skillHelpers.reps)(5, 3), ["nordic_curl.ecc_nordic"], {
    evidence: "D",
    description: "3×5 unassisted descents timed at 3 s to the floor, hands catching. First tempo rung above 'controlled to floor'."
  }),
  (0, _skillHelpers.node)("nordic_curl.ecc_8s", "Nordic Negative 8 s", "posterior", 3.5, (0, _skillHelpers.reps)(5, 3), ["nordic_curl.slow_ecc_nordic"], {
    evidence: "D",
    description: "3×5 at an 8 s descent — the deepest eccentric rung before any concentric attempt."
  }),
  (0, _skillHelpers.node)("nordic_curl.partial_concentric", "Partial-ROM Nordic", "posterior", 3.7, (0, _skillHelpers.reps)(3, 3), [
  "nordic_curl.ecc_8s"],
  ...
  (0, _skillHelpers.node)("nordic_curl.arms_crossed", "Arms-Crossed Nordic", "posterior", 4.5, (0, _skillHelpers.reps)(3, 3), [
  ...
  (0, _skillHelpers.node)("posterior_base.hip_thrust_2x", "Hip Thrust 2×BW", "posterior", 1.5, (0, _skillHelpers.wreps)(5, 2.0, 3), [
  "barbell.hip_thrust"],
  ...
  (0, _skillHelpers.node)("barbell_deadlift.2_25xbw", "Deadlift 2.25×BW", "posterior", 1.5, (0, _skillHelpers.e1rmRatio)("deadlift", 2.25), [
